...
export default async function StudentDashboardPage() {
  ...
  if (!data) return <div className="screen">Profil bulunamadı.</div>;
    ...
    <div className="screen">
      <div className="page-head">
        <div className="page-title">
          ...
          {data.hasActiveCoach ? (
            <p>Koçun: <strong>{data.coachName}</strong></p>
          ) : (
            <p>Henüz aktif bir koçun yok.</p>
          )}
        </div>
      </div>
      ...
      {data.hasActiveCoach && (
        <div className="panel p-5 mb-4">
          <div className="flex items-center justify-between mb-3">
            <span style={{ fontWeight: 700, fontSize: 15 }}>Bu haftaki programım</span>
            {hasProgram && (
            ...
            <>
              <div style={{
                ...
                <div style={{
                  ...
                  borderRadius: 999,
                  background: data.weeklyCompletion === 100 ? "var(--good)" : "var(--accent)",
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                <span style={{
                  fontSize: 13,
                  color: data.weeklyCompletion === 100 ? "var(--good-ink)" : "var(--accent-ink)",
                  fontWeight: 600,
                }}>
          ...
          {!hasProgram && (
            <p style={{ fontSize: 13, color: "var(--muted)", marginTop: 12, marginBottom: 0, textAlign: "center" }}>
