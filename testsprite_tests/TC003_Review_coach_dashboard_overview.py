...
async def run_test():
    ...
    try:
        ...
        raise AssertionError("Test blocked during agent run: " + "TEST BLOCKED The coach dashboard could not be reached \u2014 a server-side rendering error on the login page prevents successful sign-in. Observations: - The login page displays the message: \"An error occurred in the Server Components render. The specific message is omitted in production builds to avoid leaking sensitive details.\" (visible under the password field). - After filling credentials and a...")
