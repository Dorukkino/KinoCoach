...
async def run_test():
    ...
    try:
        ...
        # -> Open the sign-in page by navigating to http://localhost:3001/login so the login form can be filled with invalid credentials.
        ...
        # -> Fill the email field with invalid@example.com, fill the password with invalid-password, then click the 'Giriş yap' submit button.
