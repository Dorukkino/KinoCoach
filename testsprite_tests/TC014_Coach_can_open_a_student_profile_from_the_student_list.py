...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Giriş' (login) link (interactive element index 11) to navigate to the login page.
        # link "Giriş"
        elem = page.locator("xpath=/html/body/div[2]/nav/div/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the coach email and password into inputs 89 and 91, then submit the login form by clicking button 92.
